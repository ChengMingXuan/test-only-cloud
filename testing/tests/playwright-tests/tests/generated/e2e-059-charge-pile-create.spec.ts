...
test.describe('[E2E] 添加充电桩', () => {
  ...
  test.describe('页面访问', () => {
    test('[E001] 页面加载成功', async ({ page }) => {
      await page.goto('/charging/piles/create');
    ...
    test('[E003] 路由正确', async ({ page }) => {
      await page.goto('/charging/piles/create');
      expect(page.url()).toContain('/charging/piles/create');
    });
    ...
    test('[E005] 导航菜单渲染', async ({ page }) => {
      ...
      if (await nav5.count() > 0) await expect(nav5.first()).toBeVisible();
    });
  ...
  test.describe('权限验证', () => {
    ...
    test('[E016] 菜单权限过滤', async ({ page }) => {
      ...
      if (await nav16.count() > 0) await expect(nav16.first()).toBeVisible();
    });
  ...
  test.describe('CRUD操作', () => {
    ...
    test('[E022] 点击新增按钮', async ({ page }) => {
      ...
      await expect(addBtn22.first()).toBeVisible();
    ...
    test('[E024] 新增表单填写', async ({ page }) => {
      ...
      await expect(addBtn24.first()).toBeVisible();
      await addBtn24.first().click();
      const input24 = page.locator('.ant-modal input').first();
      await expect(input24.first()).toBeVisible();
    ...
    test('[E025] 新增提交成功', async ({ page }) => {
      ...
      await expect(addBtn25.first()).toBeVisible();
    ...
    test('[E027] 编辑数据回显', async ({ page }) => {
      ...
      await expect(editBtn27.first()).toBeVisible();
    ...
    test('[E028] 编辑提交成功', async ({ page }) => {
      ...
      await expect(editBtn28.first()).toBeVisible();
    ...
    test('[E030] 删除确认', async ({ page }) => {
      ...
      await expect(delBtn30.first()).toBeVisible();
    ...
    test('[E032] 批量操作', async ({ page }) => {
      ...
      await expect(checkbox32.first()).toBeVisible();
  ...
  test.describe('搜索筛选', () => {
    ...
    test('[E037] 关键词搜索', async ({ page }) => {
      ...
      await expect(si37.first()).toBeVisible();
    ...
    test('[E038] 搜索清空', async ({ page }) => {
      ...
      await expect(si38.first()).toBeVisible();
    ...
    test('[E040] 下拉筛选', async ({ page }) => {
      ...
      await expect(sel40.first()).toBeVisible();
    ...
    test('[E043] 分页切换', async ({ page }) => {
      ...
      await expect(pgNext.first()).toBeVisible();
    ...
    test('[E045] 排序切换', async ({ page }) => {
      ...
      await expect(sorter.first()).toBeVisible();
  ...
  test.describe('表单交互', () => {
    test('[E046] 表单弹窗打开', async ({ page }) => {
      ...
      await expect(addBtn46.first()).toBeVisible();
    ...
    test('[E047] 表单ESC关闭', async ({ page }) => {
      ...
      await expect(addBtn47.first()).toBeVisible();
    ...
    test('[E048] 表单取消关闭', async ({ page }) => {
      ...
      await expect(addBtn48.first()).toBeVisible();
    ...
    test('[E049] 表单必填校验', async ({ page }) => {
      ...
      await expect(addBtn49.first()).toBeVisible();
    ...
    test('[E050] 输入框聚焦', async ({ page }) => {
      ...
      await expect(addBtn50.first()).toBeVisible();
    ...
    test('[E051] 下拉选择', async ({ page }) => {
      ...
      await expect(addBtn51.first()).toBeVisible();
    ...
    test('[E052] 日期选择', async ({ page }) => {
      ...
      await expect(addBtn52.first()).toBeVisible();
    ...
    test('[E053] 上传组件', async ({ page }) => {
      ...
      await expect(addBtn53.first()).toBeVisible();
    ...
    test('[E054] 富文本编辑', async ({ page }) => {
      ...
      await expect(addBtn54.first()).toBeVisible();
    ...
    test('[E055] 表单联动', async ({ page }) => {
      ...
      await expect(addBtn55.first()).toBeVisible();
  ...
  test.describe('UI组件', () => {
    ...
    test('[E062] Tooltip提示', async ({ page }) => {
      ...
      await expect(titled.first()).toBeVisible();
    ...
    test('[E063] 下拉菜单', async ({ page }) => {
      ...
      await expect(ddTrigger.first()).toBeVisible();
