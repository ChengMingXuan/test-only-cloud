 ...
 * 资源列表 - k6 性能测试场景
 * 服务: permission
 * 端点: GET /api/permission/resources
 * 场景数: 40
 */
...
const ENDPOINT = '/api/permission/resources';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_perm_resources');
const requestCounter = new Counter('requests_perm_resources');
