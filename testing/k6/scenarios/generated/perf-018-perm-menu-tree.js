 ...
 * 菜单树 - k6 性能测试场景
 * 服务: permission
 * 端点: GET /api/permission/menus/tree
 * 场景数: 40
 */
...
const ENDPOINT = '/api/permission/menus/tree';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_perm_menu_tree');
const requestCounter = new Counter('requests_perm_menu_tree');
