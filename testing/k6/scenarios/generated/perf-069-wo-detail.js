 ...
 * 工单详情 - k6 性能测试场景
 * 服务: workorder
 * 端点: GET /api/workorder/orders/{id}
 * 场景数: 40
 */
...
const ENDPOINT = '/api/workorder/orders/00000000-0000-0000-0000-000000000001';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_wo_detail');
const requestCounter = new Counter('requests_wo_detail');
