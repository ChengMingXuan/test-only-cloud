 ...
 * 场站设备 - k6 性能测试场景
 * 服务: station
 * 端点: GET /api/station/stations/{id}/devices
 * 场景数: 40
 */
...
const ENDPOINT = '/api/station/stations/00000000-0000-0000-0000-000000000001/devices';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_station_devices');
const requestCounter = new Counter('requests_station_devices');
