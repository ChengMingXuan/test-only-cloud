 ...
 * 对账 - k6 性能测试场景
 * 服务: settlement
 * 端点: GET /api/settlement/reconcile
 * 场景数: 40
 */
...
const ENDPOINT = '/api/settlement/reconcile';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_settle_reconcile');
const requestCounter = new Counter('requests_settle_reconcile');
