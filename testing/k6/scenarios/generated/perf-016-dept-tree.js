...
const ENDPOINT = '/api/account/depts/tree';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_dept_tree');
const requestCounter = new Counter('requests_dept_tree');
