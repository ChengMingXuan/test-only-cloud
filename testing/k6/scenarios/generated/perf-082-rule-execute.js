 ...
 * 执行规则 - k6 性能测试场景
 * 服务: ruleengine
 * 端点: POST /api/ruleengine/execute
 * 场景数: 40
 */
...
const ENDPOINT = '/api/ruleengine/execute';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_rule_execute');
const requestCounter = new Counter('requests_rule_execute');
