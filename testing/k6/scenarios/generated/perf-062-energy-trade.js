...
const ENDPOINT = '/api/energy/electrade';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_energy_trade');
const requestCounter = new Counter('requests_energy_trade');
