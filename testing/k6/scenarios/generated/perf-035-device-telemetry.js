 ...
 * 遥测数据 - k6 性能测试场景
 * 服务: device
 * 端点: GET /api/device/devices/{id}/telemetry
 * 场景数: 40
 */
...
const ENDPOINT = '/api/device/devices/00000000-0000-0000-0000-000000000001/telemetry';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_device_telemetry');
const requestCounter = new Counter('requests_device_telemetry');
