...
const ENDPOINT = '/api/energy/demandresp';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_energy_demand');
const requestCounter = new Counter('requests_energy_demand');
