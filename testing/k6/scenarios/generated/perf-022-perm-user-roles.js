 ...
 * 用户角色 - k6 性能测试场景
 * 服务: permission
 * 端点: GET /api/permission/users/{id}/roles
 * 场景数: 40
 */
...
const ENDPOINT = '/api/permission/users/00000000-0000-0000-0000-000000000001/roles';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_perm_user_roles');
const requestCounter = new Counter('requests_perm_user_roles');
