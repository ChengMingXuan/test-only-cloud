 ...
 * 账单详情 - k6 性能测试场景
 * 服务: settlement
 * 端点: GET /api/settlement/bills/{id}
 * 场景数: 40
 */
...
const ENDPOINT = '/api/settlement/bills/00000000-0000-0000-0000-000000000001';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_settle_bill_detail');
const requestCounter = new Counter('requests_settle_bill_detail');
