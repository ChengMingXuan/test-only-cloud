 ...
 * 更新场站 - k6 性能测试场景
 * 服务: station
 * 端点: PUT /api/station/stations/{id}
 * 场景数: 40
 */
...
const ENDPOINT = '/api/station/stations/00000000-0000-0000-0000-000000000001';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_station_update');
const requestCounter = new Counter('requests_station_update');
