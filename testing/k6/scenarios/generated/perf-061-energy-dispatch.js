 ...
 * 调度指令 - k6 性能测试场景
 * 服务: orchestrator
 * 端点: POST /api/energy/orchestrator/dispatch
 * 场景数: 40
 */
...
const ENDPOINT = '/api/energy/orchestrator/dispatch';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_energy_dispatch');
const requestCounter = new Counter('requests_energy_dispatch');
