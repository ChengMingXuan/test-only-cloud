 ...
 * 充电桩状态 - k6 性能测试场景
 * 服务: charging
 * 端点: GET /api/charging/piles/{id}/status
 * 场景数: 40
 */
...
const ENDPOINT = '/api/charging/piles/00000000-0000-0000-0000-000000000001/status';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_charge_pile_status');
const requestCounter = new Counter('requests_charge_pile_status');
