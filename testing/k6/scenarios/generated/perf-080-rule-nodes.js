...
const ENDPOINT = '/api/ruleengine/nodes';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_rule_nodes');
const requestCounter = new Counter('requests_rule_nodes');
