 ...
 * 角色授权 - k6 性能测试场景
 * 服务: permission
 * 端点: POST /api/permission/roles/{id}/permissions
 * 场景数: 40
 */
...
const ENDPOINT = '/api/permission/roles/00000000-0000-0000-0000-000000000001/permissions';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_perm_role_assign');
const requestCounter = new Counter('requests_perm_role_assign');
