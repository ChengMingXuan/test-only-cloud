 ...
 * 删除用户 - k6 性能测试场景
 * 服务: account
 * 端点: DELETE /api/account/users/{id}
 * 场景数: 40
 */
...
const ENDPOINT = '/api/account/users/00000000-0000-0000-0000-000000000001';
const MOCK_TOKEN = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.test';

// 自定义指标
const errorRate = new Rate('errors');
const responseTrend = new Trend('response_time_user_delete');
const requestCounter = new Counter('requests_user_delete');
